...
export default function TableRow({
  ...
  return (
    ...
    >
      ...
      <td
        key={1}
        className="shadow-r-inner sticky left-[59px] z-10 mx-0 border-spacing-x-1 whitespace-nowrap border border-l-0 border-solid border-gray-200 bg-white px-3 py-3"
      >
        {cells[0]}
      </td>

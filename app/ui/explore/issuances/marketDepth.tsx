        ...
        <div className='w-full'>
            <Accordion>
                ...
                <AccordionDetails className='shadow-lg rounded-lg mt-0 pt-0'>
                    <div className='flex flex-col h-[360px] overflow-auto divide-y divide-solid divide-gray-200'>
                        <div className="m-0 flex w-full flex-row justify-between p-0 text-xs divide-x divide-solid divide-gray-200">
                            <div className="m-0 w-full">
                                <p className="text-green-500 m-0 px-2 py-1">Buy</p>
                            </div>
                            <div className="w-full">
                                <p className="text-red-500 m-0 px-2 py-1">Sell</p>
                            </div>
                        </div>
